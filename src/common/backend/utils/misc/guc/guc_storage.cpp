...
static void InitStorageConfigureNamesBool()
{
    struct config_bool localConfigureNamesBool[] = {
        ...
        {{"enable_multi_tenant",
            ...
            NODE_ALL,
            RESOURCES_MEM,
            gettext_noop("whether enable multi-tenant."),
            NULL},
            &g_instance.attr.attr_storage.enable_multi_tenant,
            false,
            NULL,
            NULL,
            NULL},
        {{"enable_random",
            ...
            NODE_ALL,
            RESOURCES_MEM,
            gettext_noop("whether enable random."),
            NULL},
            &g_instance.attr.attr_storage.enable_random,
            false,
            NULL,
            NULL,
            NULL},
        {{"enable_mtrp",
            ...
            NODE_ALL,
            RESOURCES_MEM,
            gettext_noop("whether enable mtrp"),
            NULL},
            &g_instance.attr.attr_storage.enable_mtrp,
            true,
            NULL,
            NULL,
            NULL
        ...
        {{"enable_twb",
            ...
            NODE_ALL,
            RESOURCES_MEM,
            gettext_noop("whether enable tempo write buffer"),
            NULL},
            &g_instance.attr.attr_storage.enable_twb,
            false,
            NULL,
            NULL,
            NULL
        ...
        {{"enable_lruc",
            ...
            NODE_ALL,
            RESOURCES_MEM,
            gettext_noop("whether enable lruc flusher"),
            NULL},
            &g_instance.attr.attr_storage.enable_lruc,
            false,
            NULL,
            NULL,
            NULL
        ...
        {{"enable_tail_scan",
            ...
            NODE_ALL,
            RESOURCES_MEM,
            gettext_noop("whether enable lru tail scan"),
            NULL},
            &g_instance.attr.attr_storage.enable_tail_scan,
            false,
            NULL,
            NULL,
            NULL
        ...
        {{"buffer_type_scan",
            ...
            NODE_ALL,
            RESOURCES_MEM,
            gettext_noop("whether enable buffer_type_scan"),
            NULL},
            &g_instance.attr.attr_storage.buffer_type_scan,
            false,
            NULL,
            NULL,
            NULL
        ...
        {{"skip_filter",
            ...
            NODE_ALL,
            RESOURCES_MEM,
            gettext_noop("whether filter index split page"),
            NULL},
            &g_instance.attr.attr_storage.skip_filter,
            false,
            NULL,
            NULL,
            NULL
        ...
        {{"enable_lru",
            ...
            NULL},
            &g_instance.attr.attr_storage.enable_lru,
            false,
            NULL,
            NULL,
            NULL
        ...
        {{"enable_update_weight",
            ...
            NODE_ALL,
            RESOURCES_MEM,
            gettext_noop("whether enable update weight"),
            NULL},
            &g_instance.attr.attr_storage.enable_update_weight,
            true,
            NULL,
            NULL,
            NULL
        },
        {{"enable_update_struct",
            PGC_POSTMASTER,
            NODE_ALL,
            RESOURCES_MEM,
            gettext_noop("whether enable update struct"),
            NULL},
            &g_instance.attr.attr_storage.enable_update_struct,
            true,
            NULL,
            NULL,
            NULL
        ...
        {{"enable_sampling",
            ...
            NODE_ALL,
            RESOURCES_MEM,
            gettext_noop("whether enable sampling"),
            NULL},
            &g_instance.attr.attr_storage.enable_sampling,
            true,
            NULL,
            NULL,
            NULL
        ...
        {{"enable_log",
            ...
            NODE_ALL,
            RESOURCES_MEM,
            gettext_noop("whether enable log"),
            NULL},
            &g_instance.attr.attr_storage.enable_log,
            true,
            NULL,
            NULL,
            NULL
...
static void InitStorageConfigureNamesInt()
{
    struct config_int localConfigureNamesInt[] = {
        ...
        {{"max_tenant",
            ...
            NODE_ALL,
            RESOURCES_MEM,
            gettext_noop("Sets the number of max_tenant."),
            NULL,
            GUC_UNIT_BLOCKS},
            &g_instance.attr.attr_storage.max_tenant,
            32,
            1,
            INT_MAX / 2,
            NULL,
        ...
        {{"sample_num",
            ...
            NODE_ALL,
            RESOURCES_MEM,
            gettext_noop("Sets the number of sample num."),
            NULL,
            GUC_UNIT_BLOCKS},
            &g_instance.attr.attr_storage.sample_num,
            5,
            1,
            INT_MAX / 2,
            NULL,
        ...
        {{"twb_size",
            ...
            NODE_ALL,
            RESOURCES_MEM,
            gettext_noop("Sets the number of twb size."),
            NULL,
            GUC_UNIT_BLOCKS},
            &g_instance.attr.attr_storage.twb_size,
            1024,
            1,
            INT_MAX / 2,
            NULL,
        ...
        {{"max_lruc_scan_len",
            ...
            NODE_ALL,
            RESOURCES_MEM,
            gettext_noop("Sets the number of lruc scan len."),
            NULL,
            GUC_UNIT_BLOCKS},
            &g_instance.attr.attr_storage.max_lruc_scan_len,
            1024,
            1,
            INT_MAX / 2,
            NULL,
            NULL,
            NULL},
        {{"flush_max_write_count",
            PGC_POSTMASTER,
            NODE_ALL,
            RESOURCES_MEM,
            gettext_noop("When write count of buf over it, just pass"),
            NULL,
            GUC_UNIT_BLOCKS},
            &g_instance.attr.attr_storage.flush_max_write_count,
            -1,
            -100,
            INT_MAX / 2,
            NULL,
        ...
        {{"extra_mem_factor",
            ...
            NODE_ALL,
            RESOURCES_MEM,
            gettext_noop("Sets the extra_mem_factor."),
            NULL,
            GUC_UNIT_BLOCKS},
            &g_instance.attr.attr_storage.extra_mem_factor,
            8,
            1,
            INT_MAX / 2,
            NULL,
        ...
        {{"write_lat_us",
            ...
            NULL,
            GUC_UNIT_BLOCKS},
            &g_instance.attr.attr_storage.write_lat_us,
            2000,
            1,
            INT_MAX / 2,
            NULL,
        ...
        {{"lat_type",
            ...
            NODE_ALL,
            RESOURCES_MEM,
            gettext_noop("Sets the lat sim type."),
            NULL,
            GUC_UNIT_BLOCKS},
            &g_instance.attr.attr_storage.lat_type,
            1,
            1,
            3,
            NULL,
        ...
        {{"lat_ratio",
            ...
            NODE_ALL,
            RESOURCES_MEM,
            gettext_noop("Sets the lat sim ratio."),
            NULL,
            GUC_UNIT_BLOCKS},
            &g_instance.attr.attr_storage.lat_ratio,
            30,
            1,
            100,
            NULL,
...
static void InitStorageConfigureNamesInt64()
{
    struct config_int64 localConfigureNamesInt64[] = {
        ...
        {{"log_interval",
            ...
            NODE_ALL,
            AUTOVACUUM,
            gettext_noop("log_interval."),
            NULL},
            &g_instance.attr.attr_storage.log_interval,
            /* see pg_resetxlog if you change the upper-limit value */
            INT64CONST(4000000000),
            INT64CONST(100000),
            INT64CONST(0x7FFFFFFFFFFFFFF),
